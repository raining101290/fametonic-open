  ...
  return (
    <main className="flex text-white">
        <div className="max-w-screen-2xl mx-auto px-6 lg:px-[211px] grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Left: Text */}
            <div className="relative z-10 md:mt-[57px] order-2 md:order-1">
                ...
                <div className="md:text-left text-center flex flex-col">
                    <div className="order-1 md:order-2 color-gray md:mt-6 mb-6">
                        ...
                        <p>
                            <small className='text-xs-custom'>Fametonic 2025 ©All Rights Reserved.</small>
                        </p>
                    </div>

                    <div className="w-full md:w-[313px] mb-6 md:mb-0 text-center order-2 md:order-1">
                        <button className="get-started-btn btn-shadow text-xl font-bold">
                            Get Started <ArrowRight />
                        </button>
                        <small className="mt-3 inline-block text-xs">1-minute quiz for personalized Insights</small>
                    </div>
                </div>
            </div>
            {/* Right: Image */}
